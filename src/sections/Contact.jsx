...
const Contact = () => {
  ...
  return (
    <>
      <div className="relative w-full h-[122.87500rem] max-sm:h-[75.5rem] overflow-hidden">
        <img className="max-sm:hidden z-2 absolute inset-0 w-full h-full object-cover object-center" src="/bg-connect.png" />
        <img className="hidden max-sm:block z-2 absolute inset-0 w-full h-full object-cover object-center" src="/bg-connect-mb.png" />
        {/* Towel */}
        ...
        {/* '' */}
        <div className="max-sm:hidden z-2 absolute bottom-[-7.5rem] max-sm:bottom-[-0.9375rem] right-[-10.35rem] max-sm:right-[0.01438rem] font-biz text-[77.00825rem] max-sm:text-[16.90163rem] not-italic font-normal leading-[88.5595rem] max-sm:leading-[19.43681rem] tracking-[-3.08031rem] max-sm:tracking-[-0.67606rem] opacity-[0.12] bg-[linear-gradient(1deg,#AD765B_79.54%,rgba(71,48,37,0.00)94.66%)] bg-clip-text text-transparent rotate-180">"</div>

        {/* Form */}
        <div className="z-10 absolute top-[3.38rem] max-sm:top-[2.5rem] right-[5rem] max-sm:right-0 flex w-[36.5rem] max-sm:w-full max-sm:px-[1rem] flex-col items-start gap-[2rem]">
          ...
          >
            ...
            <button
              type="submit"
              className="cursor-pointer flex h-[3rem] max-sm:h-[2.5rem] py-[0.5rem] pr-[0.75rem] max-sm:pr-[0.375rem] pl-[1.5rem] max-sm:pl-[0.75rem] items-center gap-[0.5rem] rounded-[0.5rem] bg-[linear-gradient(97deg,#5C321E_-3.86%,#95502F_51.97%,#F5C178_117.18%)]"
            >
